...
import com.boviet.common.utils.file.MimeTypeUtils;
import com.boviet.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(BovietConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
